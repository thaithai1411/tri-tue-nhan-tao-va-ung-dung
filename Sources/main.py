...
def initGame(map):
	...
	desText = desSize.render('Choose a map!!!', True, WHITE)
	...
	algorithmRect = algorithmText.get_rect(center=(400, 680))
...
def loadingGame():
	...
	text_1 = fontLoading_1.render('TAKE YOUR TIME!', True, WHITE)
	text_rect_1 = text_1.get_rect(center=(320, 60))
	screen.blit(text_1, text_rect_1)

	fontLoading_2 = pygame.font.Font('gameFont.ttf', 20)
	text_2 = fontLoading_2.render('*peep pop peep pop*', True, WHITE)
...
def foundGame(map):
	...
	text_1 = font_1.render('Everything was right with the obvious!!!', True, WHITE)
